...
<body>
    ...
    <form action="" method="post" class="formulario-conter">
        ...
        <button class="formulario-button" type="submit">Iniciar Sesión</button>
    </form>
        <div class="sesion-div">
            <div class="flecha">
                ...
                <div class="bb">
                <a class="formulario-btn" href="register.php"><button class="formulario-btnn formulario-btnn-register"></button></a>
                </div>
        </div>
    </div>
</body>
